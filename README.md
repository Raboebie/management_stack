...
All records point to the host IP (`192.168.88.100`). TLS is provided by a `*.home` wildcard certificate generated by mkcert (trusted in the local system CA store). HTTP requests are automatically redirected to HTTPS.
